 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
#define HSE_STARTUP_TIMEOUT  ((uint32_t)0xa00000)   /*!< Time out for HSE start up */
...
#define __STM32F2XX_STDPERIPH_VERSION_SUB2   (0x02) /*!< [7:0]  STM32F2XX Standard Peripheral Library sub2 version */
